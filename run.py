...
def run_sim(trials_phase1,trials_phase2,num_KC,KC_baseline,odor_activation,odor_phase1,odor_phase2,w1_init,w2_init,w3_init,w5_init,w6_init, w7_init,w8_init, w1_connection,w2_connection,lr_wKC_gamma,lr_wKC_alpha,CT_factor,DAN_activation=False,DAN_activation_gamma_alpha=False,con_timing=False,con_neuron=False):
    ...
    KC, wKC_MBONalpha, wKC_MBONgamma, wKC_MBONgamma5,wMBONg1_MBONg5,wMBONg5_MBONa2,wMBONalpha_DAN, wMBONgamma_DAN, MBONalpha, MBONgamma, MBONgamma5,DAN, DAN_gamma_alpha, CT = create_network(num_KC=num_KC,w1_init=w1_init,w2_init=w2_init,w3_init=w3_init,w5_init=w5_init,w6_init=w6_init,w7_init=w7_init,w8_init=w8_init,w1_connection=w1_connection,w2_connection=w2_connection)
    ...
    for i, trial in enumerate(np.arange(1,trials_phase1+1)):
        ...
        KC, DAN, DAN_gamma_alpha, CT, MBONalpha, MBONgamma, MBONgamma5, weights = single_trials_sim(num_KC=num_KC, KC_baseline=KC_baseline,
                                                                   ...
                                                                   MBONalpha=MBONalpha, MBONgamma=MBONgamma, DAN=DAN,DAN_gamma_alpha=DAN_gamma_alpha, CT=CT,
                                                                   lr_wKC_gamma=lr_wKC_gamma,lr_wKC_alpha=lr_wKC_alpha, CT_factor=CT_factor,
    ...
    return KC_rate ,DAN_rate, DAN_gamma_alpha_rate, DAN_CT, MBONalpha_rate, MBONgamma_rate, MBONgamma5_rate, KC_MBONalpha_weights, KC_MBONgamma_weights,  MBONalpha_DAN_weights,test_CS1 ,test_CS2, test_ctl


KC_rate, DAN_rate, DAN_gamma_alpha_rate, DAN_CT, MBONalpha_rate, MBONgamma_rate, MBONgamma5_rate, KC_MBONalpha_weights, KC_MBONgamma_weights, MBONalpha_DAN_weights,test_CS1 ,test_CS2,test_ctl = run_sim(trials_phase1=3,
                                                                                                                                                                               trials_phase2=3,
                                                                                                                                                                              num_KC=2000,
                                                                                                                                                                              KC_baseline=0,
                                                                                                                                                                              odor_activation=10,
...
ax2.set_ylabel('DAN CT',fontsize=10)
ax2.plot(np.arange(len(MBONalpha_DAN_weights)), DAN_CT, 'x',color=[0.93,0.11,0.14])
